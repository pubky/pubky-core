...
pub fn generate_4words_passphrase() -> String {
...
/// Dictionary from the [EFF large wordlist](https://www.eff.org/files/2016/07/18/eff_large_wordlist.txt)
static EFF_LARGE: &[&str] = &[
    "abacus",
    "abdomen",
    "abdominal",
    "abide",
