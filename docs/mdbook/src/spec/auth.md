...
3. Verify that the `timestamp` is within a window from the local time: the default should be 3 minutes in the past and 3 minutes in the future to handle latency and drifts.
