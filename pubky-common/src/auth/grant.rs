...
///
/// All public key fields use [`PublicKey`] (z32 string in JSON).
...
impl GrantClaims {
    ...
    /// Sign the GrantClaims as a JWS using the provided keypair.
    /// `jws_type` is the JWS "typ" header value (e.g. "pubky-grant").
